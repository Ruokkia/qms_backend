...
import com.kangli.qms.entity.ImprovementAction;
...
import com.kangli.qms.mapper.EscalationMapper;
import com.kangli.qms.mapper.Exception8dMapper;
import com.kangli.qms.mapper.ExceptionOrderMapper;
import com.kangli.qms.mapper.ImprovementActionMapper;
import com.kangli.qms.mapper.MaterialInspectionMapper;
...
import com.kangli.qms.service.NotificationService;
import com.kangli.qms.vo.CloseReadinessVO;
import com.kangli.qms.vo.EightDVO;
import com.kangli.qms.vo.ExceptionAnalysisItemVO;
...
import com.kangli.qms.vo.QualityExceptionDecisionVO;
...
public class ExceptionServiceImpl implements ExceptionService {
    ...
    public ExceptionDetailVO detail(Long id) {
        ...
        // 通知数
        LambdaQueryWrapper<com.kangli.qms.entity.Notification> notificationWrapper = new LambdaQueryWrapper<>();
        notificationWrapper.eq(com.kangli.qms.entity.Notification::getBusinessId, id)
                .eq(com.kangli.qms.entity.Notification::getBusinessType, "EXCEPTION_ORDER");
    ...
    private void createAutomaticEscalationIfNeeded(ExceptionOrder order, MaterialInspection inspection,
        ...
        escalation.setSupplierId(order.getSupplierId());
